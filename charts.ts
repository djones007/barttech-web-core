 ...
 * pins the consuming repo to recharts 2 (this is why one consumer's vendored
 ...
 * Taken from one internal dashboard's existing palette, which was the
 * estate's only real-world chart palette in production use at the time.
 */
