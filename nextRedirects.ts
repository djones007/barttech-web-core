...
// found serving internal documentation — nuttyorange.games/CLAUDE.md,
// berekindled.com/logos/CLAUDE.md, dominic-jones.com/images/CLAUDE.md and
// /logos/CLAUDE.md, ownerfoundry.com/images/blog/CLAUDE.md — every one returning
